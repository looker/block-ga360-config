...
#Scenario 1: You are viewing a single GA 360 property
...
#Scenario 2: You are viewing Multiple  GA 360 properties in the same BQ project and are leveraging analytics across multiple properties
...
# TODO: Uncomment field
  # filter: partition_filter {
  #   type: date
  #   default_value: "@{EXPLORE_DATE_FILTER}"
  # }

# TODO: Uncomment field and comment out the partition date above
  # dimension_group: partition {
  #   # Date that is parsed from the table name. Required as a filter to avoid accidental massive queries
  #   label: ""
  #   view_label: "Session"
...
# TODO: Uncomment out the field and update the property and website names
  # dimension: property {
  #   hidden: yes
...
#Option 3: Multiple properties but allow specific users to view their own properties

# TODO: Create a user attribute ga_360_schema and assign values for each user.
